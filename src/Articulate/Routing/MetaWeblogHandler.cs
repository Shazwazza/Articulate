...
//{
//    [XmlRpcService]
//    public class MetaWeblogHandler : IMetaWeblog, IBloggerMetaWeblog, IWordPressMetaWeblog, IRouteHandler
//    {
...
//        public MetaWeblogHandler(IUmbracoContextAccessor umbracoContextAccessor,
...
//            if (post != null)
//            {
//                return FromPost(new PostModel(post,_publishedValueFallback, _variationContextAccessor, _imageUrlGenerator));
//            }
...
//            {
//                var fileUrl = "articulate/" + media.Name.ToSafeFileName(_shortStringHelper);
//                _fileSystem.AddFile(fileUrl, ms);
//                var absUrl = _fileSystem.GetUrl(fileUrl);
...
//                        var mediaFileSystemPath = _fileSystem.GetUrl(relativePath);
...
//        {
//            var node = _umbracoContextAccessor.GetRequiredUmbracoContext().Content.GetById(BlogRootId);
