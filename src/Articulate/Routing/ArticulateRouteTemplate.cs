...
namespace Articulate.Routing
{
        ...
        IEqualityOperators<ArticulateRouteTemplate, ArticulateRouteTemplate, bool>
    {
        ...
        internal TemplateMatcher Matcher { get; } = new(routeTemplate, new RouteValueDictionary());

        public static bool operator ==(ArticulateRouteTemplate left, ArticulateRouteTemplate right) =>
            left.Equals(right);
